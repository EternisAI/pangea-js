...
export function build_bbs_proof(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
export function verify_bbs_proof(a: number, b: number, c: number, d: number, e: number, f: number): number;
...
export function prover_notarize(a: number, b: number, c: number): number;
...
export function __wbg_attributeattestation_free(a: number, b: number): void;
export function attributeattestation_serialize(a: number, b: number): void;
export function attributeattestation_deserialize(a: number, b: number, c: number): void;
...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbb15dd9b1f798100(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hcaba4c5381c23f5d(a: number, b: number, c: number): void;
