...
export function build_bbs_proof(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h573f09877f6605d6(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2484157486a28d27(a: number, b: number): void;
